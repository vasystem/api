...
static ::_pb::Metadata file_level_metadata_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto[3];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto = nullptr;

const uint32_t TableStruct_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto = {
    false, false, 582, descriptor_table_protodef_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto,
    "vasystem/api/v2/virtual_airline.proto",
    &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_once, nullptr, 0, 3,
    schemas, file_default_instances, TableStruct_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto::offsets,
    file_level_metadata_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto, file_level_enum_descriptors_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto,
    file_level_service_descriptors_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_getter() {
  return &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto(&descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto);
namespace vasystem {
namespace api {
namespace v2 {
...
::PROTOBUF_NAMESPACE_ID::Metadata GetVirtualAirlineRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_getter, &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_once,
      file_level_metadata_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GetVirtualAirlineResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_getter, &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_once,
      file_level_metadata_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VirtualAirline::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_getter, &descriptor_table_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto_once,
      file_level_metadata_vasystem_2fapi_2fv2_2fvirtual_5fairline_2eproto[2]);
}
